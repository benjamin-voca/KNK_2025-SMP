...
public class CreateStudentRejectedDto {
    ...
    private CreateStudentRejectedDto(int id, String name, String surname, String address, int age, double gpa, String ethnicity, int extraCredit, double testScore, int acceptanceTestScore, String programIntended) {
        this.id = id;
        this.name = name;
